...
print('vocab size',len(sp_model.wv.vocab))
sentence = raw_input('Enter sentence here: ');
...
for j in range(0, 20):
	...
	if(j==0 or 1 or 2):
		maxInd = randrange(0,len(sp_model.wv.vocab));
	...
	if maxInd==ind:
		...
		#print(maxInd)
		word_pred = sp_model.wv.index2word[maxInd]
		#print(word_pred)
